...
public class AdmPersistenciaMovCtaCteMySQL_NoUsar {
	static private AdmPersistenciaMovCtaCteMySQL_NoUsar instancia;
	
	private AdmPersistenciaMovCtaCteMySQL_NoUsar() {
		
	}
	
	public static AdmPersistenciaMovCtaCteMySQL_NoUsar getInstancia(){
		if (instancia == null) {
			instancia = new AdmPersistenciaMovCtaCteMySQL_NoUsar();
		}
		return instancia;
	}
